...
func NewComplex64(start, end complex64, startex, endex bool) *Complex64 {
	return &Complex64{
		start:   start,
		end:     end,
		startex: startex,
...
func (r *Complex64) Start() complex64 { return r.start }
func (r *Complex64) End() complex64   { return r.end }
func (r *Complex64) Startex() bool    { return r.startex }
func (r *Complex64) Endex() bool      { return r.endex }

func (r *Complex64) IsEmpty() bool {
	if r.empty {
		return true
	}
	if r.start > r.end || r.start == r.end && (r.startex || r.endex) {
...
func (r *Complex64) In(x complex64) bool {
	if r.IsEmpty() {
		return false
	}
	if r.start > x || r.startex && r.start == x {
...
func Complex64Inter(x, y *Complex64) *Complex64 {
	r := &Complex64{}
...
func Complex64Union(x, y *Complex64) *Complex64 {
	r := &Complex64{}
...
func NewComplex128(start, end complex128, startex, endex bool) *Complex128 {
	return &Complex128{
		start:   start,
		end:     end,
		startex: startex,
...
func (r *Complex128) Start() complex128 { return r.start }
func (r *Complex128) End() complex128   { return r.end }
func (r *Complex128) Startex() bool     { return r.startex }
func (r *Complex128) Endex() bool       { return r.endex }

func (r *Complex128) IsEmpty() bool {
	if r.empty {
		return true
	}
	if r.start > r.end || r.start == r.end && (r.startex || r.endex) {
...
func (r *Complex128) In(x complex128) bool {
	if r.IsEmpty() {
		return false
	}
	if r.start > x || r.startex && r.start == x {
...
func Complex128Inter(x, y *Complex128) *Complex128 {
	r := &Complex128{}
...
func Complex128Union(x, y *Complex128) *Complex128 {
	r := &Complex128{}
